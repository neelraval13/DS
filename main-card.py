...
df = pd.read_csv("Credit_Card_Fraud_Detection\creditcard.csv\creditcard.csv")
...
print(cl("-----------------------------------------------------------------------------------", attrs = ["bold"]))
print(cl("Accuracy score of XGBoost model is {}".format(accuracy_score(y_test, xgb_yhat)), attrs = ["bold"]))
print(cl("-----------------------------------------------------------------------------------", attrs = ["bold"]))
...
print(cl("-----------------------------------------------------------------------------------", attrs = ["bold"]))
print(cl("F1 score of XGBoost model is {}".format(f1_score(y_test, xgb_yhat)), attrs = ["bold"]))
print(cl("-----------------------------------------------------------------------------------", attrs = ["bold"]))
